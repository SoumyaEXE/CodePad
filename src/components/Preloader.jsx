...
export default function Preloader({ onFinish }) {
  ...
  return (
    <StyledPreloader className={fadeOut ? 'fade-out' : ''}>
...
const StyledPreloader = styled.div`
  ...
  .brand {
    ...
    opacity: 0;
    animation: brand-in 0.8s ease 0.5s forwards;
  }
  ...
  .loading-bar-track {
    ...
    overflow: hidden;
    opacity: 0;
    animation: brand-in 0.6s ease 1s forwards;
  }
  ...
  .loading-text {
    ...
    margin: 0;
    opacity: 0;
    animation: brand-in 0.6s ease 1.2s forwards;
  }

  /* ── Server SVG animations ── */
  .container_SevMini {
    display: flex;
    justify-content: center;
    align-items: center;
